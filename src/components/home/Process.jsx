...
const steps = [
  {
    ...
    description: 'We dive deep into your vision, crafting detailed storyboards that map out every frame of your product\'s cinematic journey.',
    details: ['Creative briefing', 'Mood boards', 'Shot planning', 'Timeline mapping'],
    color: 'cyan',
  },
  {
    number: '02',
    ...
    description: 'Your product is meticulously recreated in stunning 3D with photorealistic materials and precise attention to every detail.',
    details: ['CAD integration', 'Material creation', 'UV mapping', 'Detail refinement'],
    color: 'violet',
  },
  {
    number: '03',
    ...
    description: 'Dynamic camera movements and fluid animations bring your product to life with cinematic flair and purposeful motion.',
    details: ['Camera choreography', 'Physics simulation', 'Motion design', 'Visual effects'],
    color: 'amber',
  },
  {
    number: '04',
    ...
    description: 'Final renders are polished to perfection with color grading, sound design, and platform-specific optimization.',
    details: ['GPU rendering', 'Color grading', 'Sound design', 'Format delivery'],
    color: 'emerald',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            A refined workflow perfected over hundreds of projects, ensuring exceptional results every time.
          </p>
        </motion.div>
