...
const services = [
  {
    ...
    description: 'Captivating product animations optimized for marketing campaigns, social media, and presentations. Showcase your products in stunning detail.',
    features: ['Cinematic quality', '360° product views', 'Social media ready'],
  ...
  },
  {
    ...
    description: 'Detailed product animations highlighting key features, materials, functionality, and unique selling points that drive sales.',
  ...
  },
  {
    ...
    subtitle: 'Assembly & Exploded Views',
    description: 'Clear assembly sequences, exploded views, and installation animations that simplify complex product assembly for customers and installers.',
    features: ['Exploded views', 'Assembly steps', 'Industrial animation'],
